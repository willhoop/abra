 ...
 *
 * ================= 2026-09-24 (abra/regmc 0.87.0) — THE REG M-C CHECKOUT HAS NO `isCharging` GUARD =====
 *
...
console.log('  MEDI_CHARGE_TURN_NEVER_DRAWS=' + (KNOB2 ? '1  (PRE-0.87.0 ENGINE: a charging turn never draws)' : '0'));
