...
const K = require('./regmc_probe_kit.js').open('probe_intimidate_reactors',
  ['MEDI_GUARD_DOG_REFUSES_ONLY', 'MEDI_RATTLED_IGNORES_INTIMIDATE', 'MEDI_REFUSAL_LABEL_DISPLAY'], { anyRegulation: true });
const { D, ok, SPEC, learns, abil, quiet, bulk, mon, pickDistinct, show, P } = K;

console.log('\n1. THE CAST, DERIVED THIS RUN (' + K.CS.FORMAT + ')');
const REACT = ['guarddog', 'rattled', 'innerfocus', 'oblivious', 'owntempo', 'scrappy'];   /* 0.74.0, 0.75.0, 0.76.0 */
