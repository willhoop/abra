...
const M = [
  { id:'store', name:'STORE', tier:'data', status:'live', metric:'every public Showdown replay',
  ...
  { id:'medicham', name:'MEDI', full:'Medicham', tier:'damage', status:'validated', metric:'damage maths',
  ...
  { id:'guru', name:'GURU', full:'Oranguru', tier:'input', status:'built', metric:'archetype matchups',
    detail:'Which archetype beats which, measured with error bars.', sees:'team-preview six only. No moves, no items.', inputs:['store'] },
  { id:'xatu', name:'XATU', full:'Xatu', tier:'input', status:'built', metric:'reads the opponent',
  ...
  { id:'pory', name:'PORY', full:'Porygon', tier:'input', status:'win', metric:'live win chance',
  ...
  { id:'dusk', name:'DUSK', full:'Dusclops', tier:'roadmap', status:'roadmap', metric:'solves endgames',
  ...
  { id:'hypno', name:'HYPNO', full:'Hypno', tier:'roadmap', status:'roadmap', metric:'rates the opponent',
  ...
  { id:'mew', name:'MEW', full:'Mew', tier:'roadmap', status:'roadmap', metric:'self-play games',
  ...
  { id:'chomp', name:'CHOMP', full:'Garchomp', tier:'decision', status:'null', metric:'picks your four',
  ...
  { id:'slowking', name:'KING', full:'Slowking', tier:'decision', status:'built', metric:'the unexploitable mix',
    detail:'Finds the unexploitable mix at team preview.', sees:'team-preview six only, reduced to archetypes.', inputs:['guru','medicham'] },
  { id:'ditto', name:'DITTO', full:'Ditto', tier:'decision', status:'pivot', metric:'builds teams',
    detail:'Builds a team to beat the current meta.', sees:'your full six with sets - it is editing them.', inputs:['slowking','medicham'] },
  { id:'kadabra', name:'KADABRA', full:'Kadabra', tier:'decision', status:'built', metric:'coaches a replay',
  ...
  { id:'alakazam', name:'ALAKAZAM', full:'Alakazam', tier:'capstone', status:'dev', metric:'in-battle coach',
  ...
  { id:'jolteon', name:'JOLT', full:'Jolteon', tier:'retired', status:'retired', metric:'win% from sheets',
  ...
  { id:'medi_win', name:'MEDI win%', full:'Medicham', tier:'retired', status:'retired', metric:'old win% guess',
