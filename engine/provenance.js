...
if (process.argv.includes('--graph')) {
  /* --graph --json emits the derived graph as data, so a second tool can REUSE this derivation
   * instead of growing its own. engine/quarantine.js needs the artifact->generator->inputs edges to
   * decide what is downstream of MEDICHAM; parsing the padded table below would be a second parser of
   * a format that exists to be read by a human, and CLAUDE.md's `buildMon("Scizor")` lesson is about
