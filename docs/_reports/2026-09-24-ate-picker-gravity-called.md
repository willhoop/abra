...
## Task 2 — Gravity refuses a gravity-flagged move, called or chosen (abra/regmc 0.90.0)
...
| Reg M-B on this tree | 1007 (0.88.0's parked census) | **1008 live**, parked at `data/verification/mechanics-census-f801ab8410ce.json` |

The published `data/mechanics-census.json` stays at HEAD (1004). This is the call 0.87.0 and 0.88.0 made, because the
