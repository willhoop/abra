# ROADMAP #310 closed: every engine `battleInit` hands the lead-in a stream. 2026-09-24 (abra/regmc 0.101.0, provisional)

ENGINE. Worktree `worktree-agent-aace036dabfd3b91c` off `3dc5ea54` (abra/regmc 0.91.0). The brief named `9af27acd` (0.100.3,
...
REGULATION-ROTATION.md rows were NOT brought over: they belong to 0.100.3 and arrive with that commit's own merge.
...
The instrument's own list (from the 0.100.3 report) was eight sites. The new static clause found **two more** that the
...
Nothing went down. The Reg M-B +2 is NOT this change: the 0.100.3 report regenerated 1006 on `7c9f7534`, before any of
