...
## 1. Natural Cure and Regenerator (`ability/switch-out`) — commit 0.102.0
...
## 2. Effect Spore (`ability/contact-statuses-the-attacker-by-chance`) — commit 0.103.0
...
## 3. Belch and `move/needs-a-berry-already-eaten` — commit 0.104.0
