...
- **Corner 1, Reflect Type at a typeless target that carries an added type: FIXED (0.97.0), both regulations**,
...
## 5. Corner 1 — Reflect Type at a typeless target that carries an added type (0.97.0)
...
| Reg M-B | `ad7726f19a85` | 0.96.0 | RED, the same three failures (corner 2 does not close corner 1) |
...
| Reg M-C | `d4b43852870d` | 0.96.0 | RED, the same three failures |
...
Artifacts not committed, as for 0.96.0.
...
- **Census, regenerated on this tree.** Reg M-B: 1007 live on the base tree (0.95.0's report; also the 0.96.0 tree
  under its knob, 1007 + 1 missing) → 1009 live, 0 missing. Reg M-C: 1011 (0.95.0's report) → 1013 live, 0 missing. The committed
