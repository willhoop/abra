...
| 0a | **Sequencing: do NOT re-run any gate before #0 lands** | R1 and the explore sweep, R3, R4 and the in-game half of the leaf calibration are all invalidated by #0. Re-running them first buys a **second round** of invalidation. R2 is unaffected — leaf cost measured unchanged, 17.53 → 16.93 ms | — |
