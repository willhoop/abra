...
| #92 | **THE DAMAGE-STAGE CLASS.** We apply multipliers at the wrong STAGE and often unchained. Black Glasses on final damage where Showdown does base power was 108 vs 109; the class covers the 18 type items, Technician, Tough Claws, Sharpness, Thick Fat (73%), Water Bubble (77%), Helping Hand (5/5 rows), Sniper, Friend Guard, the 44 unread `damageBoost` abilities, terrain (161 uses — Will corrected my "most games"), and the crit's position. Control residual is 4.1%, so these are not rounding. Full audit in `docs/DAMAGE-STAGES.md` | engine free after 3.71.0 |
