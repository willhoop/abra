...
<!-- BEGIN:FUNNEL -->
Of **76,839** games collected, **17,970** are usable — **23.4%**.
...
|---|---|
| collected | 76,839 |
| after removing named bots | 39,605 |
| after removing accounts that behave like bots | 35,056 |
| after removing forfeits | 22,619 |
| after removing games under 3 turns | 22,435 |
| after requiring all four brought to be revealed | **17,970** |
<!-- END:FUNNEL -->
...
<!-- BEGIN:RAWREADERS -->
**24 engine tools still read the store with neither the clean filter nor a declared reason.**
...
Anything they publish is computed over a store that is 76.6% unusable.
<!-- END:RAWREADERS -->
