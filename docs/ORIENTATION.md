...
<!-- BEGIN:FUNNEL -->
Of **82,518** games collected, **20,724** are usable — **25.1%**.
...
|---|---|
| collected | 82,518 |
| after removing named bots | 45,076 |
| after removing accounts that behave like bots | 40,141 |
| after removing forfeits | 26,038 |
| after removing games under 3 turns | 25,830 |
| after requiring all four brought to be revealed | **20,724** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 74.9% unusable.
<!-- END:RAWREADERS -->
