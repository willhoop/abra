...
<!-- BEGIN:FUNNEL -->
Of **78,195** games collected, **18,537** are usable — **23.7%**.
...
|---|---|
| collected | 78,195 |
| after removing named bots | 40,804 |
| after removing accounts that behave like bots | 36,125 |
| after removing forfeits | 23,344 |
| after removing games under 3 turns | 23,154 |
| after requiring all four brought to be revealed | **18,537** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 76.3% unusable.
<!-- END:RAWREADERS -->
