...
<!-- BEGIN:FUNNEL -->
Of **68,064** games collected, **14,849** are usable — **21.8%**.
...
|---|---|
| collected | 68,064 |
| after removing named bots | 32,899 |
| after removing accounts that behave like bots | 28,994 |
| after removing forfeits | 18,693 |
| after removing games under 3 turns | 18,538 |
| after requiring all four brought to be revealed | **14,849** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 78.2% unusable.
<!-- END:RAWREADERS -->
