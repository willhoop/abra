...
<!-- BEGIN:FUNNEL -->
Of **93,900** games collected, **25,781** are usable — **27.5%**.
...
|---|---|
| collected | 93,900 |
| after removing named bots | 54,796 |
| after removing accounts that behave like bots | 48,755 |
| after removing forfeits | 32,470 |
| after removing games under 3 turns | 32,235 |
| after requiring all four brought to be revealed | **25,781** |
<!-- END:FUNNEL -->
