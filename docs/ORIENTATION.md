...
<!-- BEGIN:FUNNEL -->
Of **64,702** games collected, **13,316** are usable — **20.6%**.
...
|---|---|
| collected | 64,702 |
| after removing named bots | 29,611 |
| after removing accounts that behave like bots | 26,098 |
| after removing forfeits | 16,776 |
| after removing games under 3 turns | 16,635 |
| after requiring all four brought to be revealed | **13,316** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 79.4% unusable.
<!-- END:RAWREADERS -->
