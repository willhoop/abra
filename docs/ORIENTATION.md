...
<!-- BEGIN:FUNNEL -->
Of **82,188** games collected, **20,567** are usable — **25.0%**.
...
|---|---|
| collected | 82,188 |
| after removing named bots | 44,748 |
| after removing accounts that behave like bots | 39,821 |
| after removing forfeits | 25,841 |
| after removing games under 3 turns | 25,633 |
| after requiring all four brought to be revealed | **20,567** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 75.0% unusable.
<!-- END:RAWREADERS -->
