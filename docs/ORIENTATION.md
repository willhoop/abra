...
<!-- BEGIN:FUNNEL -->
Of **73,863** games collected, **16,875** are usable — **22.8%**.
...
|---|---|
| collected | 73,863 |
| after removing named bots | 37,191 |
| after removing accounts that behave like bots | 33,016 |
| after removing forfeits | 21,224 |
| after removing games under 3 turns | 21,056 |
| after requiring all four brought to be revealed | **16,875** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 77.2% unusable.
<!-- END:RAWREADERS -->
