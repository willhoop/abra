...
<!-- BEGIN:FUNNEL -->
Of **80,743** games collected, **19,847** are usable — **24.6%**.
...
|---|---|
| collected | 80,743 |
| after removing named bots | 42,863 |
| after removing accounts that behave like bots | 38,222 |
| after removing forfeits | 24,995 |
| after removing games under 3 turns | 24,798 |
| after requiring all four brought to be revealed | **19,847** |
<!-- END:FUNNEL -->
