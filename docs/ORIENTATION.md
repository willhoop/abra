...
<!-- BEGIN:FUNNEL -->
Of **81,091** games collected, **20,023** are usable — **24.7%**.
...
|---|---|
| collected | 81,091 |
| after removing named bots | 43,655 |
| after removing accounts that behave like bots | 38,827 |
| after removing forfeits | 25,187 |
| after removing games under 3 turns | 24,985 |
| after requiring all four brought to be revealed | **20,023** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 75.3% unusable.
<!-- END:RAWREADERS -->
