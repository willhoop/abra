...
<!-- BEGIN:FUNNEL -->
Of **18,279** games collected, **2,368** are usable — **13.0%**.
...
|---|---|
| collected | 18,279 |
| after removing named bots | 6,523 |
| after removing accounts that behave like bots | 4,556 |
| after removing forfeits | 2,908 |
| after removing games under 3 turns | 2,888 |
| after requiring all four brought to be revealed | **2,368** |
<!-- END:FUNNEL -->
