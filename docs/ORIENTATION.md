...
<!-- BEGIN:FUNNEL -->
Of **80,404** games collected, **19,694** are usable — **24.5%**.
...
|---|---|
| collected | 80,404 |
| after removing named bots | 42,585 |
| after removing accounts that behave like bots | 37,947 |
| after removing forfeits | 24,809 |
| after removing games under 3 turns | 24,613 |
| after requiring all four brought to be revealed | **19,694** |
<!-- END:FUNNEL -->
