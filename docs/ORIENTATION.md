...
<!-- BEGIN:FUNNEL -->
Of **93,779** games collected, **25,703** are usable — **27.4%**.
...
|---|---|
| collected | 93,779 |
| after removing named bots | 54,675 |
| after removing accounts that behave like bots | 48,634 |
| after removing forfeits | 32,354 |
| after removing games under 3 turns | 32,119 |
| after requiring all four brought to be revealed | **25,703** |
<!-- END:FUNNEL -->
