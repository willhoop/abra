...
<!-- BEGIN:FUNNEL -->
Of **78,484** games collected, **18,704** are usable — **23.8%**.
...
|---|---|
| collected | 78,484 |
| after removing named bots | 41,093 |
| after removing accounts that behave like bots | 36,412 |
| after removing forfeits | 23,550 |
| after removing games under 3 turns | 23,359 |
| after requiring all four brought to be revealed | **18,704** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 76.2% unusable.
<!-- END:RAWREADERS -->
