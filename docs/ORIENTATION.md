...
<!-- BEGIN:FUNNEL -->
Of **19,807** games collected, **2,583** are usable — **13.0%**.
...
|---|---|
| collected | 19,807 |
| after removing named bots | 6,992 |
| after removing accounts that behave like bots | 5,025 |
| after removing forfeits | 3,170 |
| after removing games under 3 turns | 3,143 |
| after requiring all four brought to be revealed | **2,583** |
<!-- END:FUNNEL -->
