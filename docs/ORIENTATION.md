...
<!-- BEGIN:FUNNEL -->
Of **18,580** games collected, **2,410** are usable — **13.0%**.
...
|---|---|
| collected | 18,580 |
| after removing named bots | 6,612 |
| after removing accounts that behave like bots | 4,645 |
| after removing forfeits | 2,959 |
| after removing games under 3 turns | 2,938 |
| after requiring all four brought to be revealed | **2,410** |
<!-- END:FUNNEL -->
