...
<!-- BEGIN:FUNNEL -->
Of **76,430** games collected, **17,776** are usable — **23.3%**.
...
|---|---|
| collected | 76,430 |
| after removing named bots | 39,268 |
| after removing accounts that behave like bots | 34,677 |
| after removing forfeits | 22,364 |
| after removing games under 3 turns | 22,182 |
| after requiring all four brought to be revealed | **17,776** |
<!-- END:FUNNEL -->
...
Anything they publish is computed over a store that is 76.7% unusable.
<!-- END:RAWREADERS -->
