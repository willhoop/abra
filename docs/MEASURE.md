...
MEASURE — can we believe a number
  ...
  provenance: 188 unsafe, 2 void (declared), 41 possibly stale, 20 ok, 0 missing
  ...
  REFIT OWED — weights fitted 2026-08-28 15:46
    ...
    moved after the fit: engine/medicham2-browser.js  2026-08-30 16:16
    moved after the fit: data/engine-data.js  2026-08-30 23:38
