...
MEASURE — can we believe a number
  leaf calibration: QUARANTINED — the figure is withheld, not annotated.
    ...
    MEDICHAM is not correct — 2 of 10 gate clauses fail (whole-game differential / NARRATION — protocol divergence with no board effect, on EVERY team lattice; mechanics / each one staged and compared against showdown)
  ...
  provenance: 222 unsafe, 2 void (declared), 17 possibly stale, 19 ok, 0 missing
