...
MEASURE — can we believe a number
  ...
  provenance: 24 unsafe, 1 void (declared), 83 possibly stale, 82 ok, 0 missing
  ...
  REFIT OWED — weights fitted 2026-08-05 00:00
    ...
    moved after the fit: engine/medicham2-browser.js  2026-08-11 13:14
    moved after the fit: engine/board.js  2026-08-10 20:33
    moved after the fit: data/engine-data.js  2026-08-10 18:59
    moved after the fit: data/abra-tags.js  2026-08-11 13:03
```
