...
MEASURE — can we believe a number
  leaf calibration: QUARANTINED — the figure is withheld, not annotated.
    ...
    MEDICHAM is not correct — 1 of 7 gate clauses fail (whole-game differential / the same game on both engines)
  ...
  provenance: 25 unsafe, 1 void (declared), 90 possibly stale, 84 ok, 0 missing
  ...
  REFIT OWED — weights fitted 2026-08-05 00:00
    ...
    moved after the fit: engine/medicham2-browser.js  2026-08-12 21:49
