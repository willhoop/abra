...
MEASURE — can we believe a number
  ...
  provenance: 25 unsafe, 1 void (declared), 112 possibly stale, 93 ok, 0 missing
  ...
  REFIT OWED — weights fitted 2026-08-05 00:00
    ...
    moved after the fit: engine/medicham2-browser.js  2026-08-25 01:37
    moved after the fit: engine/board.js  2026-08-23 15:27
    moved after the fit: data/engine-data.js  2026-08-22 01:46
    moved after the fit: data/abra-tags.js  2026-08-24 22:59
```
