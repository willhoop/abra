...
MEASURE — can we believe a number
  ...
  provenance: 21 unsafe, 1 void (declared), 73 possibly stale, 84 ok, 0 missing
  ...
  REFIT OWED — weights fitted 2026-08-05 00:00
    ...
    moved after the fit: engine/medicham2-browser.js  2026-08-10 22:22
    moved after the fit: engine/board.js  2026-08-10 20:33
    moved after the fit: data/engine-data.js  2026-08-10 18:59
    moved after the fit: data/abra-tags.js  2026-08-10 22:17
```
