...
MEASURE — can we believe a number
  leaf calibration: QUARANTINED — the figure is withheld, not annotated.
    ...
    MEDICHAM is not correct — 3 of 10 gate clauses fail (deliberate roster / abilities; whole-game differential / NARRATION — protocol divergence with no board effect, on EVERY team lattice; mechanics / each one staged and compared against showdown)
  ...
  provenance: 222 unsafe, 2 void (declared), 18 possibly stale, 18 ok, 0 missing
  ...
  REFIT OWED — weights fitted 2026-08-28 15:46
    ...
    moved after the fit: engine/medicham2-browser.js  2026-09-19 22:59
    moved after the fit: data/engine-data.js  2026-08-31 00:08
    moved after the fit: data/abra-tags.js  2026-09-19 22:59
```
