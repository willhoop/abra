...
MEASURE — can we believe a number
  ...
  provenance: 197 unsafe, 2 void (declared), 17 possibly stale, 21 ok, 0 missing
  ...
  REFIT OWED — weights fitted 2026-08-05 00:00
    ...
    moved after the fit: engine/medicham2-browser.js  2026-08-28 01:29
    moved after the fit: engine/board.js  2026-08-23 15:27
    moved after the fit: data/engine-data.js  2026-08-22 01:46
    moved after the fit: data/abra-tags.js  2026-08-28 01:06
```
