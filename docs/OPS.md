...
```
OPS — the live bot and the store
  store: 71476 games, 20842 usable (29.2%), 18998 teams   (live.js 2026-08-29)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-29 06:01
  data/games.bo3.jsonl         last written 2026-08-29 06:02  <- the Force-OTS format, collected hourly
