...
```
OPS — the live bot and the store
  store: 46987 games, 8392 usable (17.9%), 8323 teams   (live.js 2026-08-06)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-06 22:01
  data/games.bo3.jsonl         last written 2026-08-06 22:01  <- the Force-OTS format, collected hourly
