...
```
OPS — the live bot and the store
  store: 74792 games, 22786 usable (30.5%), 20488 teams   (live.js 2026-08-28)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-28 15:01
  data/games.bo3.jsonl         last written 2026-08-28 15:02  <- the Force-OTS format, collected hourly
