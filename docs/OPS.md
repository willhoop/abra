...
```
OPS — the live bot and the store
  store: 71716 games, 20943 usable (29.2%), 19093 teams   (live.js 2026-08-29)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-29 12:02
  data/games.bo3.jsonl         last written 2026-08-29 12:02  <- the Force-OTS format, collected hourly
