...
```
OPS — the live bot and the store
  store: 72354 games, 21361 usable (29.5%), 19445 teams   (live.js 2026-08-30)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-30 00:05
  data/games.bo3.jsonl         last written 2026-08-30 00:05  <- the Force-OTS format, collected hourly
