...
```
OPS — the live bot and the store
  store: 48594 games, 9257 usable (19%), 9113 teams   (live.js 2026-08-07)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-08 07:01
  data/games.bo3.jsonl         last written 2026-08-08 07:03  <- the Force-OTS format, collected hourly
