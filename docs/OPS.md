...
```
OPS — the live bot and the store
  store: 76430 games, 23454 usable (30.7%), 21054 teams   (live.js 2026-08-29)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-29 03:03
  data/games.bo3.jsonl         last written 2026-08-29 03:03  <- the Force-OTS format, collected hourly
