...
```
OPS — the live bot and the store
  store: 69067 games, 20153 usable (29.2%), 18410 teams   (live.js 2026-08-25)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-25 15:01
  data/games.bo3.jsonl         last written 2026-08-25 15:01  <- the Force-OTS format, collected hourly
