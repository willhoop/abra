...
```
OPS — the live bot and the store
  store: 71819 games, 21396 usable (29.8%), 19388 teams   (live.js 2026-08-26)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-27 09:02
  data/games.bo3.jsonl         last written 2026-08-27 09:02  <- the Force-OTS format, collected hourly
