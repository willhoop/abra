...
```
OPS — the live bot and the store
  store: 51589 games, 11044 usable (21.4%), 10640 teams   (live.js 2026-08-10)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-10 07:01
  data/games.bo3.jsonl         last written 2026-08-10 07:02  <- the Force-OTS format, collected hourly
