...
```
OPS — the live bot and the store
  store: 47942 games, 8887 usable (18.5%), 8773 teams   (live.js 2026-08-07)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-07 22:03
  data/games.bo3.jsonl         last written 2026-08-07 22:03  <- the Force-OTS format, collected hourly
  data/games.ots.jsonl         last written 2026-07-25 03:46  <- FROZEN external import, complete; date is an import, not a heartbeat
```

_stamped 2026-08-07 23:05_
