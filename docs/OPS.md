...
```
OPS — the live bot and the store
  store: 44605 games, 7992 usable (17.9%), 7967 teams   (live.js 2026-08-06)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-06 07:03
  data/games.bo3.jsonl         last written 2026-08-06 07:04  <- the Force-OTS format, collected hourly
