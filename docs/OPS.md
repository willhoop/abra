...
```
OPS — the live bot and the store
  store: 54063 games, 12290 usable (22.7%), 11697 teams   (live.js 2026-08-12)
  live-games/: 34 battles recorded
  data/games.ladder.jsonl      last written 2026-08-12 18:02
  data/games.bo3.jsonl         last written 2026-08-12 18:02  <- the Force-OTS format, collected hourly
