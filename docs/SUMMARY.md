...
| **XATU** | Opponent set + next-move belief | ✅ Built | Behaviour-clone top-1 **0.293** / top-3 **0.6459** on 118,274 held-out human clicks, cross-entropy 2.3365 against baselines 4.7124 / 3.6978 — beats both (`data/policy-eval.json:species_only_clone`, re-run 2026-09-09 under quality filter 1.3.0; the rounded pair this row carried until 2026-09-09 was in no artifact) |
