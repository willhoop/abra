...
**Version 3.62.0 · 2026-08-07 · Will Hooper**

**THE DIFFERENTIAL HAS RUN, AND MEGAS ARE IN IT (3.62.0).** `engine/game_differential.js` plays a real
...
## The headline finding, 2026-08-06 — VGC is a poker problem, and the metric changes (3.62.0)
...
| **SLOWKING** | Team-preview Nash (mixed strategy) — **and, since ADR-003 (3.62.0), the shape of the whole agent rather than the preview solver**: equilibrium mixing plus continual re-solving is the answer poker reached for exactly this class of game | ✅ Built | Equilibrium ≪ exploitable than uniform; playstyle cycle is **suggestive on small samples** |
