...
**Change record for 3.62.0.** The headline metric changed. It was the win rate. It is now the
...
**Do not quote an engine-speed figure from a document (added 3.62.0).**
...
turns/sec in the 3.62.0 correction. No artifact holds any of them. No test compares them. No ratchet
...
### 4.-2 Why the exploitability is the headline metric (added 3.62.0)
