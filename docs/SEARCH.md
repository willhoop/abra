...
SEARCH — does MILTANK choose better than MAG
  R1 leaf accuracy: WITHHELD — engine/provenance.js calls data/rollout-r1-explore1.json UNSAFE.
    ...
    pinned to engine release 3932186b59ef — engine/medicham2-browser.js matches the frozen copy; live is 38b78c98148e now (a PRE-CHANGE measurement of that release, not corruption)
  ...
  runs vs engine (newest engine source: data/abra-tags.js 2026-09-10 22:46):
