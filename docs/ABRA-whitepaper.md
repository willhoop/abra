...
| deliberate roster (`data/roster.items.json`, `data/roster.abilities.json`, `data/roster.moves.json`) | **148 / 190 / 487 tested**, 0 FIRED-AND-BOARDS-DIFFER and 0 DID-NOT-FIRE on all three |
...
| clause | reading |
|---|---|
| deliberate roster — items / abilities / moves (`data/roster.items.json`, `data/roster.abilities.json`, `data/roster.moves.json`) | **148 / 190 / 487 tested** (of 148, 200 and 497 in scope), 0 FIRED-AND-BOARDS-DIFFER and 0 DID-NOT-FIRE on all three; red demonstrations **22 / 62 / 36**, all caught |
...
| clause | reading |
|---|---|
| deliberate roster — items / abilities / moves (`data/roster.items.json`, `data/roster.abilities.json`, `data/roster.moves.json`) | **148 / 190 / 487 tested**, 0 FIRED-AND-BOARDS-DIFFER and 0 DID-NOT-FIRE on all three; red demonstrations **22 / 62 / 36** |
...
`data/roster.abilities.json` **190 tested**, `data/roster.moves.json` **487 tested**, every stage with
