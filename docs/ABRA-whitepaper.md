...
**Discrete choice — the scoring bot's policy (v3.7.1).** A player facing a turn chooses one of the
...
4. **Policy is the residual GIGO — reduced in 3.7.1, not removed.** The damage is validated; the
