...
`data/roster.abilities.json` **194 tested**, `data/roster.moves.json` **494 tested** (re-measured on release `a1c7dcd5696b`, CHANGELOG 6.53.0), every stage with
