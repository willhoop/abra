...
**Version 3.9.2 · Last updated 2026-07-26**
**Will Hooper · ABRA**
...
**Discrete choice — the scoring bot's policy (v3.9.2).** A player facing a turn chooses one of the
...
4. **Policy is the residual GIGO — reduced in 3.9.2, not removed.** The damage is validated; the
