...
| **MACHAMP** | Training loop / league | MEW games → next checkpoint | MEW, PORYGON2, MAG/DODUO | **v0 built** (`solver/machamp/`): 2 generations gated, 0 accepted (beats-previous 0.525 and 0.520 at n = 200) | G1: generation n+1 beats n by SPRT on the same release | the previous checkpoint |
