...
| **PORYGON2** | Value net | state + world → P(win) | MEDICHAM (relational facts), MEW data | To build | V0/V1/V2 ladder (App. B) | count-HP logistic `[alive_diff, hp_diff]`, then the rollout leaf in the same search |
